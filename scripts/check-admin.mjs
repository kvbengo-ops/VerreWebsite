...
const tables=['products','product_images','pos_sessions','orders','order_items','stock_movements','admin_audit_log'];
...
for(const fn of ['record_sale','adjust_stock','create_inquiry','set_order_status','void_pos_sale','dashboard_snapshot']){
